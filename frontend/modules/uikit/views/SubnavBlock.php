...
<div class="advanced-subnav right-subnav">
    ...
    <?php if(count($hideSubnav)>0){ ?>
        ...
        <p class="espandi-voci px-4 small">  
            <a href="#menu-lista-altre" id="menu-lista-button-subnav" role="button" aria-expanded="false" aria-controls="menu-lista-altre" data-toggle="collapse" class="collapsed link-altre-voci d-flex align-items-center text-decoration-none">
