...
<script>
    ...
    <!--parte filtri-->
    <div id="filtri-ricerca-ord" class="d-flex flex-column flex-md-row justify-content-between pb-2 border-bottom">
        <p class="h3">Tutte le ordinanze</p>
        
        <div class="tag-filtri-container d-flex flex-wrap">
            <div class="ml-2 mb-2 d-inline">    
                <button id="filtro-tutto-ordinanze" class="active active-filter tag-filter btn btn-icon btn-outline-primary btn-sm align-top" onclick="resetFilterTag('filtro-tutto')">
                    <span>Tutto</span>
                </button>
            </div>
            ...
            <?php foreach($tagFilter as $filter){ ?>
                <div class="ml-2 mb-2 d-inline">
                    <button id="filtro-<?=str_replace(' ', '_', strtolower($filter->nome)) ?>-ordinanze" class=" tag-filter btn btn-icon btn-outline-primary btn-sm align-top" onclick="resetFilterTag('filtro-<?= $filter->nome?>'.toLowerCase())">   
            ...
            <div class="ml-2 mb-2 d-inline">
                <button  id="more-tag-ordinanze" type="button"  class="btn btn-icon btn-outline-primary btn-sm align-top h-100" data-toggle="modal" data-target="#more-option-filter-modal" onclick="onlyOne()">
                ...
                <div class="form-group mt-5" >
                    ...
                    <div class="advanced-subnav right-subnav">
                        ...
                        <div class="link-list-wrapper">
                            <div class="link-list collapse mb-0" id="altri-arg-ordinanze">
                                <div >
                                   <?php } if($showTag) { ?>
                        ...
                        <p class="espandi-voci mt-4 ">
                                <a href="#altri-arg-ordinanze" id="menu-lista-button" role="button" aria-expanded="false" aria-controls="altri-arg-ordinanze" data-toggle="collapse" class="collapsed link-altre-voci d-flex align-items-center text-decoration-none">
