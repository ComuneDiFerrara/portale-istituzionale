...
class Module extends AmosModule
{
    ...
    /**
     * 
     * @var array $rulePublications
     */
    public $publicationRules = [1];

    /**
     *
     * @var bool $enableUseFrontendView
     */
    public $enableUseFrontendView = false;

    /**
     *
     * @var bool $enableUsePrettyUrl
     */
    public $enableUsePrettyUrl = false;
