...
$currentAsset = BiLessAsset::register($this);
...
if (!$hideUserMenu && !Yii::$app->user->isGuest) {
    ...
    $menuUser = Html::tag(
        ...
        Html::tag(
            ...
            $userWelcomeMessage,
            [
                'class' => 'equal-font-size-h5 font-weight-bold'
            ]
        )
    );
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <div class="container">
                        <button class="close bold" type="button" data-dismiss="modal" aria-label="Close">
                            <span class="am am-close am-1"> </span>
                        </button>
                        <div class="modal-title h1 bold">Cerca</div>
                    </div>
                ...
                <div class="modal-body">
                    <div class="container">
                        <div class="h2 bold">Inserisci una o più parole chiave per affinare ulteriormente la ricerca</div>
                        <div class="form-group autocomplete-wrapper-big mt-5">
                            <input type="search" class="autocomplete form-control" placeholder="Testo da cercare" id="autocomplete-two" name="autocomplete-two" data-autocomplete="[]">
                            <span class="autocomplete-icon" aria-hidden="true">
                                <span class="am am-search am-4"> </span>
                            </span>
...
<div class="it-header-wrapper <?= ($enableHeaderSticky) ? 'it-header-sticky' : 'navbar-fixed-top' ?>">
                        ...
                        <div class="it-header-slim-right-zone flexbox">
                            ...
                            <?php if (!Yii::$app->user->isGuest) : ?>
                                ...
                                <?php if (\Yii::$app->getModule('myactivities')) : ?>
                                    ...
                                    ?>
                                    <div class="nav-item">
                                        <a class="nav-link pl-5" href="/site/to-menu-url?url=/myactivities/my-activities/index" data-toggle="tooltip" data-placement="bottom" title="<?= AmosMyActivities::t('amosmyactivities', 'My activities') ?>">
                            ...
                            <?php if (!$hideUserMenu) : ?>
                                <?php if (Yii::$app->user->isGuest) : ?>
                                    ...
                                    <div class="it-access-top-wrapper">
                                        <?php if ($customUserNotLogged) : ?>
                                            ...
                                            ?>
                                        <?php else : ?>
                                            <a href="<?= $loginUrl ?>" class="btn btn-icon btn-full mr-0 flexbox" title="Accedi o Registrati al portale">
                                                <span class="am am-key light flexbox"> </span>
                                ...
                                <?php else : ?>
                                    <div class="dropdown menu-profile">
                                        <a href="#" class="btn btn-icon btn-full dropdown-toggle flexbox" role="button" id="dropdownMenuProfile" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                            <span class="rounded-icon">
                                                <img class="icon icon-primary rounded-circle" src="<?= (!empty($userImage) ? $userImage : $frontendUrl .'/img/defaultProfiloM.png') ?>" alt="AS">
    ...
    <div class="it-nav-wrapper">
        <div class="it-header-center-wrapper flexbox <?= ($disableThemeLight) ? '' : 'theme-light' ?> <?= ($disableSmallHeader) ? '' : 'it-small-header' ?>">
            <div class="<?= ($fluidContainerHeader) ? 'container-fluid' : 'container' ?>">
                <div class="row flexbox">
                    <div class="col-12">
                        <div class="it-header-center-content-wrapper flexbox">
                            ...
                            <div class="it-right-zone flexbox">
                                <?php if ($showSocial) : ?>
                                    <?php
                                    echo $this->render("bi-less-header-social", [
                                        'currentAsset' => $currentAsset,
                                    ]);
                                    ?>
                                ...
                                <?php if (!($hideGlobalSearch)) : ?>
                                    ...
                                    <?= $this->render("bi-less-header-search", ['currentAsset' => $currentAsset]); ?>
